...
const teams = [
  {
    name: "P1G SEKAI",
    role: "Member",
    description: "A competitive CTF team focused on binary exploitation and reverse engineering.",
    link: "https://github.com/orgs/p1g-sekai/people",
    level: 50,
    members: 12,
    specialties: ["Binary Exploitation", "Reverse Engineering", "Web Security"],
  },
  {
    name: "Project Sekai",
    role: "Member",
    description: "A CTF team specializing in web security and cryptography.",
    link: "https://github.com/ProjectSekaiCTF",
    level: 48,
    members: 15,
    specialties: ["Web Security", "Cryptography", "Forensics"],
  },
  {
    name: "TCP1P",
    role: "Founder",
    description: "A cybersecurity team focused on CTF competitions and security research.",
    link: "https://github.com/TCP1P",
    level: 52,
    members: 20,
    specialties: ["Web Security", "Binary Exploitation", "Cryptography", "Forensics"],
  },
]
